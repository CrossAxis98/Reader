    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Row(
                ...
                val textSignUpOrLogin = if (showLoginForm.value) "Sign up" else "Login"
                val textNewUserOrAlreadyHaveAnAccout = if (showLoginForm.value) "New user?"
                else "Already have an account?"
                Text(text = textNewUserOrAlreadyHaveAnAccout)
                Text(
